                    ...
                    <form action="" method="post" role="form" class="php-email-form mt-4">
                        <div class="row">
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" name="username" id="email" placeholder="Username" value="<?php echo $id ?>">
                            </div>
                            <div class="col-md-6 form-group">

                                <input type="password" name="pass1" class="form-control" id="name" placeholder="Password" value="">
                            </div>
                            <div class="col-md-6 form-group mt-3 mt-md-0">

                                <input type="password" class="form-control" name="pass2" id="phone" placeholder="Confirm Password" value="">
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <input type="number" class="form-control" name="cusid" id="email" placeholder="CustomerID" required value="<?php echo $cusid ?>" readonly>
                        </div>
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="fname" id="address" placeholder="Fullname" required value="<?php echo $cusname ?>">
                        </div>
                        <div class="form-group mt-3">
                            <input type="email" class="form-control" name="email" id="address" placeholder="Email" required value="<?php echo $email ?>">
                        </div>
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="phone" id="address" placeholder="Phone" required value="<?php echo $tel ?>">
                        </div>
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="address" id="address" placeholder="Address" required value="<?php echo $address ?>">
                        </div>
                        <div class="my-3">
                        </div>
